        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-full min-h-[300px] md:min-h-[400px]">
            <div className="absolute inset-0 bg-agr-navy/10 rounded-lg overflow-hidden flex items-center justify-center">
              ...
              ></div>
              <div className="bg-white/95 backdrop-blur-sm p-6 md:p-8 rounded-lg shadow-lg w-5/6 max-w-md absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-0 z-10">
