      ...
      <div className="container-custom">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="hidden md:flex items-center">
            ...
            <div className="ml-6">
              <DropdownMenu>
                <DropdownMenuTrigger className="flex items-center text-agr-darkgray hover:text-agr-navy font-medium">
                  <LogIn className="mr-2 text-agr-darkgray" size={18} />
                  Log In / Register
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t">
            ...
            <div className="flex items-center text-agr-darkgray hover:text-agr-navy font-medium py-2">
              <LogIn className="mr-2 text-agr-darkgray" size={18} />
